...
GRANT SELECT, update ON "Заказы" TO storekeeper;
...
GRANT SELECT, update ON "Компоненты" TO pharmacist;
GRANT SELECT ON "Заказы" TO pharmacist;
GRANT SELECT ON "Рецепты" TO pharmacist;
GRANT SELECT ON "Больные_клиенты" TO pharmacist;
grant select, update, delete on "Резерв_компонентов" to pharmacist;
grant select, update on "Партии_компонентов" to pharmacist;
grant select, update on "Заявки_на_пополнение_компонентов" to pharmacist;
